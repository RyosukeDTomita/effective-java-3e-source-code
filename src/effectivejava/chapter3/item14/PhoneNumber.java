...
public final class PhoneNumber implements Cloneable, Comparable<PhoneNumber> {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof effectivejava.chapter3.item11.PhoneNumber)) return false;
  ...
  private static PhoneNumber randomPhoneNumber() {
    ...
    return new PhoneNumber(
        (short) rnd.nextInt(1000), (short) rnd.nextInt(1000), (short) rnd.nextInt(10000));
  }

  public static void main(String[] args) {
    NavigableSet<PhoneNumber> s = new TreeSet<PhoneNumber>();
    for (int i = 0; i < 10; i++) s.add(randomPhoneNumber());
