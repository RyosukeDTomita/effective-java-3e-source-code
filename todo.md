...
- [x] 項目９ try-よりもtry-with-resourcesを選ぶ
...
- [ ] 項目34 int定数の代わりにenumを使う: TODO 項目24のstaticメンバークラスの話をチェックする
...
- [x] 項目42 無名クラスよりもラムダを選ぶ
- [x] 項目43 ラムダよりもメソッド参照を選ぶ
- [ ] 項目44 標準の関数型インタフェースを使う
- [ ] 項目45 ストリームを注意して使う
- [x] 項目46 ストリームで副作用のない関数を選ぶ
...
- [ ] 項目52 オーバーロードを注意して使う
- [ ] 項目53 可変長引数を注意して使う
- [x] 項目54 nullではなく、空コレクションか空配列を返す
- [x] 項目55 オプショナルを注意して返す
- [x] 項目56 すべて公開のＡＰＩ要素に対してドキュメントコメントを書く
